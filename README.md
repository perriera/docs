...
# [(perriera) / extras_doc](https://github.com/perriera/extras_doc)

Welcome to the **(perriera) / extras_doc** project.
...
> 1. [Generate your project using this template](https://github.com/perriera/extras_doc/generate)<br/>
> **NOTE**: 
> When you create your project the 'extras_doc' specified <br/>below will be replaced with your project name.<br/>
> 2. Clone the project to local directory using either the https or ssh url<br/>
> `git clone git@github.com:perriera/extras_doc.git`
...
> 1. [How to setup a development environment (on Linux, Windows or Mac)](https://github.com/perriera/extras_doc/blob/dev/docs/ENVIRONMENT.md)
> 2. [How to install the tools necessary for C++11/17 projects](https://github.com/perriera/extras_doc/blob/dev/docs/INSTALL.md)
 >3. [How to clone your project (with this template)](https://github.com/perriera/extras_doc/blob/dev/docs/CLONE.md)
> 4. [How to setup your changelog.md](https://github.com/perriera/extras_doc/blob/dev/docs/CHANGELOG.md)
...
> [Open Source / MIT License](https://opensource.org/licenses/MIT) (see [LICENSE.md](https://github.com/perriera/extras_doc/blob/dev/LICENSE.md))<br/>
